...
if router:
    ...
    async def list_rooms(
        ...
        rooms = container.room_catalog(workspace_id).list_rooms(capacity_type, room_status, room_category)
    ...
    async def update_room_status(
        ...
        updated = container.room_status_service(workspace_id).release_room_to_available(request.room_number)
